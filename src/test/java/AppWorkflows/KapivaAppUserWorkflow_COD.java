...
public class KapivaAppUserWorkflow_COD extends BaseTest{
	@Test
	public void UserWokflow_COD() throws MalformedURLException, InterruptedException {
        ...
        if(logintext.equalsIgnoreCase("Harish QA")){
        	System.out.println("Logged_into_the_App");
        }else {
        ...
        System.out.println("Clicked_on_BUYNOW_button");
        
        driver.findElement(AppiumBy.accessibilityId("Cash on Delivery")).click();

        System.out.println("Selected_COD");
	    ...
	    String cuponcode= cupon.getAttribute("content-desc").replaceAll("Get extra 15% off on all orders", "");
    ...
    //SlackTest.Sendmessage("ApplyCuponCodeTest_PASS");
    	
 	    WebElement paybutton =driver.findElement(AppiumBy.accessibilityId("Pay ₹1218.00"));
 	 ...
 	 System.out.println("Clicked_on_Pay_Button");
 	    Thread.sleep(4000);
 	    
   String orderconfirmationpage=driver.findElement(AppiumBy.accessibilityId("Order Confirmation"))
		   .getAttribute("content-desc");
     
      //Assert.assertEquals("Order Confirmation", orderconfirmationpage);
   
     if(orderconfirmationpage.contains("Order Confirmation")) {
    	 System.out.println("UserWokflow_COD_Testpass");
     }else{
    	 System.out.println("UserWokflow_COD_Testfail");}
    	 
    	 Thread.sleep(5000);
    	 
    	 WebElement bk=driver.findElements(AppiumBy.className("android.widget.Button")).get(0);
    	 bk.click();
    	 driver.findElement(AppiumBy.accessibilityId("Profile")).click();
    	 driver.findElement(AppiumBy.accessibilityId("Orders")).click();
    	 driver.findElement(AppiumBy.accessibilityId("Cancel Order")).click();
    	 driver.findElement(AppiumBy.accessibilityId("Order Placed by mistake")).click();
    	 Thread.sleep(3000);
//    	 WebElement rt=driver.findElements(AppiumBy.className("android.widget.EditText")).get(0);
//    	 rt.click();
//    	 rt.sendKeys("Testing");
    	 WebElement co=driver.findElements(AppiumBy.className("android.widget.Button")).get(0);
    	 co.click();
    	 
    	// driver.findElements(AppiumBy.className("android.view.View")).get(3);
